...
# ------------------------------------------------------------------------
# Modified from (https://github.com/sldyns/MIRNet_paddle/blob/main/generate_patches_SIDD.py)
# and (https://github.com/GarrickZ2/Image-Denoising/blob/3ca4eaf0b4af900bf85355aa1d1ae1bcd2f4fcba/Restormer/Denoising/generate_patches_sidd.py)
# and (https://github.com/Yang-Liu1082/InvDN/blob/main/Crop_SIDD.py)
# ------------------------------------------------------------------------
...
parser.add_argument('--tar_dir', default='./SIDD_Medium_Srgb_Patches_512/train',type=str, help='Directory for image patches')
