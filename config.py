...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.OPTIM.BETA2 = 0.999
        self._C.OPTIM.MILESTONES = [100000, 200000, 300000, 400000, 500000]
        self._C.OPTIM.GAMMA = 0.5
        self._C.OPTIM.WEIGHT_DECAY_G = 1e-8
        self._C.OPTIM.GRADIENT_CLIPPING = 10
        self._C.OPTIM.PIXEL_CRITERION_FORW = "l2"
        self._C.OPTIM.PIXEL_CRITERION_BACK = "l1"
        self._C.OPTIM.LAMBDA_FIT_FORW = 16.
        self._C.OPTIM.LAMBDA_REC_BACK = 1
        ...
        self._C.TRAINING.GT_SIZE = 144
        # self._C.TRAINING.DATAROOT_GT = 'images_dir/train'
        # self._C.TRAINING.DATAROOT_NOISY = 'images_dir/train'
        # self._C.TRAINING.DATAROOT_LQ = 'images_dir/train'
        self._C.TRAINING.TRAIN_DIR = 'images_dir/val'
