...
def main():
    ...
    model_dir = os.path.join(opt.TRAINING.SAVE_DIR, mode, 'models-final3-resume', session)
    log_dir = os.path.join(opt.TRAINING.SAVE_DIR, mode, 'logs-final3-resume', session)
